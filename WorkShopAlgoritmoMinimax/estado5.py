# segunda parte de preparar el camino para el algoritmo del movimiento del gato
# implementaremos 2 funciones mas 
# la primera donde calcularemos el mejor movimiento dando puntajes
# y la segunda nuestros puntajes (recompensas) para nuestro gato
...
class Juego:
    ...
    def get_mejor_movimiento(self, posicion_raton):
        ...
        for movimiento in self.movimiento_valido_gato():
            ...
            puntaje = self.minimax(0, True, movimiento, posicion_raton) # ahora mismo nuestro codigo esta roto porque no existe self.minimax
